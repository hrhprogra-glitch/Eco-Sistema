...
export const appGroups: ModuleGroup[] = [
  {
    ...
    sections: [
      ...
      { slug: "pedidos", name: "Pedidos", icon: ClipboardList, implemented: true },
  ...
  },
  {
    slug: "inventario",
    name: "Inventario",
    description: "Productos, almacenes, compras, proveedores y movimientos de stock.",
    color: "#B8860B",
    icon: Package,
    sections: [
      { slug: "inventario", name: "Productos", icon: Package, implemented: true },
      { slug: "almacenes", name: "Almacenes", icon: Warehouse, implemented: true },
